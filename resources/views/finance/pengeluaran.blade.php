    ...
    <tbody class="divide-y">
      ...
      <tr>
        ...
        <td class="px-4 py-3 text-center space-x-2">
          ...
          <form action="{{ route('finance.pengeluaran.destroy', $item->id) }}"
...
<div id="modal"
  ...
  <div class="bg-white w-full max-w-md rounded-xl p-6">
    ...
    <form id="form"
          method="POST"
          data-store="{{ route('finance.pengeluaran.store') }}"
          data-update="{{ url('finance/pengeluaran') }}">
      @csrf
      ...
      <div class="mb-3">
        ...
        <input type="text" id="jumlah_dana_display"
