...
@section('content')
    <div class="bg-gray-100 p-6 flex justify-center">
        <div class="bg-white shadow-lg rounded-xl p-6 w-full max-w-md">
            ...
            <h2 class="text-xl font-bold text-center mb-4">Kalkulator Wakaf</h2>

            <!-- NOMINAL -->
            <label class="font-semibold">Nominal Wakaf</label>
            <input id="WakafInput" type="text" oninput="formatRupiah(this)" class="w-full p-3 border rounded mb-6 mt-2"
                placeholder="Masukkan nominal (Rp)">

            <button onclick="hitungWakaf()" class="w-full bg-blue-600 text-white p-3 mt-4 rounded-lg">
                Hitung
            </button>
            ...
            <div id="hasilWakaf" class="hidden mt-4 p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
            </div>
            ...
            <div id="formLanjutan" class="hidden mt-6 p-4 bg-gray-50 border rounded-lg">
                ...
                <button onclick="bayarWakaf()" class="w-full bg-green-600 text-white p-3 rounded-lg">
                    Pembayaran
                </button>
    ...
    <script>
        ...
        // Hitung Wakaf
        // ===============================
        function hitungWakaf() {
            let nilai = document.getElementById("WakafInput").value;
            ...
            document.getElementById("hasilWakaf").classList.remove("hidden");
            document.getElementById("hasilWakaf").innerText =
                "Anda berniat berWakaf sebesar: Rp " +
        ...
        function simpanRiwayat(obj) {
            let data = JSON.parse(localStorage.getItem("riwayatWakaf") || "[]");
            data.push(obj);
            localStorage.setItem("riwayatWakaf", JSON.stringify(data));
        }
        ...
        function bayarWakaf() {
            ...
            let nominal = document.getElementById("WakafInput").value;
    ...
    `;
        ...
        function downloadPDF() {
            ...
            doc.setFontSize(18);
            doc.text("STRUK PEMBAYARAN WAKAF", 20, 20);
            ...
            doc.text("Nominal Wakaf : Rp " + parseInt(d.nominal).toLocaleString("id-ID"), 20, 80);
  ...
  `);
        ...
        function downloadExcel() {
            ...
            XLSX.writeFile(wb, "riwayat-Wakaf.xlsx");
        }
        ...
        function downloadPDFAll() {
            ...
            doc.setFontSize(16);
            doc.text("Laporan Riwayat Wakaf", 20, 15);
        ...
        function resetRiwayat() {
            if (confirm("Hapus semua riwayat?")) {
                localStorage.removeItem("riwayatWakaf");
